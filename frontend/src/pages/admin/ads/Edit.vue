<template>
        ...
        <div class="px-4 py-6 sm:px-0">
          ...
          <div class="mb-8">
            <div class="flex items-center justify-between">
              <div>
                <h1 class="text-3xl font-bold text-gray-900">Editar Anúncio</h1>
          ...
          <div v-else class="bg-white shadow rounded-lg">
            <form @submit.prevent="submitForm" class="space-y-6 p-6">
              <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <!-- Imagem Atual -->
                <div v-if="form.current_image" class="sm:col-span-2">
                  <label class="block text-sm font-medium text-gray-700">
                    Imagem Atual
                  </label>
                  <div class="mt-2">
                    <img :src="form.current_image" alt="Imagem atual" class="h-32 w-auto rounded-lg shadow-md">
                  </div>
                </div>
                ...
                <div class="sm:col-span-2">
                  <label for="image" class="block text-sm font-medium text-gray-700">
                    {{ form.current_image ? 'Alterar Imagem' : 'Imagem do Anúncio' }}
                  </label>
  ...
  export default {
    ...
    methods: {
      async loadAd() {
        try {
          const response = await fetch(`/api/admin/ads/${this.$route.params.id}`, {
            headers: {
      ...
      async submitForm() {
        ...
        try {
          ...
          Object.keys(this.form).forEach(key => {
            if (key !== 'image_preview' && key !== 'current_image' && this.form[key] !== null) {
